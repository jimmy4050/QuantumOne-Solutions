        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {INDUSTRIES_DATA.map((industry) => {
              ...
              return (
                <div key={industry.name} className="bg-white p-8 rounded-lg shadow-lg text-center transform hover:-translate-y-2 hover:scale-105 transition-all duration-300 dark:bg-neutral-800 dark:shadow-none dark:border dark:border-neutral-700">
                  <div className="flex items-center justify-center bg-secondary/10 dark:bg-primary/20 rounded-full w-20 h-20 mb-6 mx-auto">
