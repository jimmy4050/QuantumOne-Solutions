...
const ServiceCard: React.FC<ServiceCardProps> = ({ service, isDetailed = false }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-2 hover:scale-105 transition-all duration-300 flex flex-col h-full dark:bg-neutral-800 dark:shadow-none dark:border dark:border-neutral-700 dark:hover:border-primary">
